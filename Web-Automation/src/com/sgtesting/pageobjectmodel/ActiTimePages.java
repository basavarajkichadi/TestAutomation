...
public class ActiTimePages {
	...
	//To create WebElement To write in Username text field
	...
	//To create WebElement To write in Retype Password text field
	...
	//*[@id="userListTableContainer"]/table/tbody/tr[1]/td[1]/table
